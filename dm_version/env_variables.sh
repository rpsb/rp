...
JENKINS_JOB=BrokerageDynVerModule; export JENKINS_JOB
...
JENKINS_JOB_URL=http://10.20.40.166:8080/job/BrokeragePipeline_8_2_1/lastSuccessfulBuild/buildNumber; export JENKINS_JOB_URL
